...
private let keyLog = Logger(subsystem: "dev.eachann.gooseagent.ios", category: "devicekey")
...
enum DeviceKey {
    ...
    static func authorizedKeysLine(_ key: Curve25519.Signing.PrivateKey, comment: String = "gooseagent-ios") -> String {
