...
final class NotificationManager: NSObject, UNUserNotificationCenterDelegate {
    ...
    /// Chime played in-app (like gooseagent's bell) so it works regardless of how the
    ...
    // Show banners even while the app is frontmost (gooseagent already suppresses
