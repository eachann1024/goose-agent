...
public enum SSHCredentialStore {
    public static let askPassModeEnvironmentKey = "GOOSEAGENT_SSH_ASKPASS"
    public static let authorizationIDEnvironmentKey = "GOOSEAGENT_SSH_AUTHORIZATION_ID"
    public static let persistenceDescription = "Saved in your macOS login Keychain"

    private static let passwordService = "dev.eachann.gooseagent.ssh-password"
    private static let authorizationService = "dev.eachann.gooseagent.ssh-authorization"
